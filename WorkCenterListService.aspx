        ...
        SPSecurity.RunWithElevatedPrivileges(delegate()
        {
            using (SPSite site = new SPSite(SPContext.Current.Site.ID))
            {
                ...
                using (SPWeb web = site.AllWebs[SPContext.Current.Web.ID])
                {
                    ...
                    SPFieldChoice fld = (SPFieldChoice)list.Fields["Work Center"];
                    DataTable dtItems = new DataTable();
                    dtItems.Columns.Add("WorkCenter", Type.GetType("System.String"));
                    foreach (string option in fld.Choices)
                    {
                        DataRow dr = dtItems.NewRow();
                        dr["WorkCenter"] = option;
                        dtItems.Rows.Add(dr);
                    }
