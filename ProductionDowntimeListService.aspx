        ...
        SPSecurity.RunWithElevatedPrivileges(delegate()
        {
            using (SPSite site = new SPSite(SPContext.Current.Site.ID))
            {
                ...
                using (SPWeb web = site.AllWebs[SPContext.Current.Web.ID])
                {
                    ...
                    SPList list = web.Lists["Production Runtime"];
                    ...
                    oQuery.Query = string.Format(@"
						<Where>
							<And>
								...
								<Gt><FieldRef Name='ShiftStart'/><Value Type='DateTime'>{1}</Value></Gt>
							</And>
						</Where>
					", workCenter, SPUtility.CreateISO8601DateTimeFromSystemDateTime(DateTime.Now.AddDays(-7)));
